...
static int test_invalid_ciphertext(void) {
    ...
    // Turns out nothing is wrong with the code.
    // Before modification, arrays were of size uint8_t*, and
    // since this is a 64 bit system, sizeof(sendb) was giving 8.
    // After mdification it is 784, which is still correct since
    // there are 784 bytes in the array or 784 places. I don't
    // exactly get it but the code isn't wrong so whatever.
    // TODO: Know exactly why it is correct.
    // printf("%ld\n", sizeof(*sendb));
